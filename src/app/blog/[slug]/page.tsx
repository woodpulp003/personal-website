...
Thus, we showed that given a particular $(x(0), \dot{x}(0))$ we obtain a unique $x(t)$, and given a particular $x(t)$ we get a unique $(x(0), \dot{x}(0))$. Thus, there is a **bijection**: $\text{solution to SHO} \leftrightarrow (x(0), \dot{x}(0))$. Further, this is a linear map:

$$
x_{1}(t) + x_{2}(t) \leftrightarrow (x_{1}(0) + x_{2}(0), \dot{x}_{1}(0) + \dot{x}_{2}(0))
$$
...
One key property of $D$ is that it **commutes with time translation**. This is just a formal way of saying:

$$
\underbrace{ \dot{x}(t+\Delta t) }_{ \text{evaluate the derivative of } x  \text{ at shifted time}}= \left( \frac{d}{dt}x \right)(t+\Delta t)= \frac{d}{dt}(x(t+\Delta t)) = \underbrace{ \dot{(x(t+\Delta t))} }_{ \text{shift }x(t) \text{, then take derivative}}
$$
...
where $C_{1},C_{2} \in \mathbb{C}$. But as we are dealing with functions that describe the motion of our particle, we require that $x(t)$ and $\dot{x}(t)$ are real valued for all $t$. We ensure that the imaginary parts of these two functions are zero, and after some algebra we end up with the general solution to the SHO:

$$
x(t) = D_{1}\cos (\omega t) + D_{2}\sin(\omega t) \qquad \text{where} \; D_{1},D_{2} \in \mathbb{R}
$$
`,
    ...
    return (
      <div className="min-h-screen bg-black text-white">
        <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
          ...
          <Link href="/blog" className="text-gray-400 hover:underline text-sm">
            ← Back to blog
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        <Link 
          href="/blog" 
          className="text-gray-400 hover:underline text-sm mb-8 inline-block"
        >
          ← Back to blog
        </Link>
        ...
        <article>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <ReactMarkdown
              ...
              components={{
                h1: ({...props}) => <h1 className="text-4xl font-bold mb-4 mt-8 text-white" {...props} />,
                h2: ({...props}) => <h2 className="text-3xl font-bold mb-3 mt-6 text-white" {...props} />,
                h3: ({...props}) => <h3 className="text-2xl font-semibold mb-2 mt-4 text-white" {...props} />,
                h4: ({...props}) => <h4 className="text-xl font-semibold mb-2 mt-4 text-white" {...props} />,
                ...
                ol: ({...props}) => <ol className="list-decimal list-inside mb-4 text-gray-300 space-y-2" {...props} />,
                li: ({...props}) => <li className="text-gray-300" {...props} />,
                code: (props: {inline?: boolean} & React.ComponentProps<'code'>) => {
                  const {inline, ...rest} = props;
                  return inline ? (
                    <code className="bg-gray-800 px-1.5 py-0.5 rounded text-gray-200 text-sm" {...rest} />
                  ) : (
                    <code className="block bg-gray-900 p-4 rounded mb-4 overflow-x-auto text-gray-200 text-sm" {...rest} />
                  );
                },
                pre: ({...props}) => <pre className="bg-gray-900 p-4 rounded mb-4 overflow-x-auto" {...props} />,
                strong: ({...props}) => <strong className="font-semibold text-white" {...props} />,
                em: ({...props}) => <em className="italic" {...props} />,
                a: ({...props}) => <a className="text-gray-400 hover:text-white underline" {...props} />,
              }}
            >
              {post.content}
            </ReactMarkdown>
